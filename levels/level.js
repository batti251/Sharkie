...
poison = [];
     ...
     */
    setBackgroundFrame(){
      return [new Background('assets/img/3. Background/Layers/5. Water/L1.png', this.x, 0),
    ...
    generatePufferfish(){
      this.levelFactor = (this.levelLength*this.enemyMultiplicator)
        ...
        this.enemies.push(new Pufferfish(`assets/img/2.Enemy/1.Puffer fish (3 color options)/1.Swim/1.swim1.png`,this.randomPufferType, this.randomXPosition))
      }
    }
    ...
    generateJellyfish(){
      this.levelFactor = (this.levelLength*this.enemyMultiplicator)
        ...
        this.setRandomTypes();
        this.setRandomPosition();
        this.enemies.push(new Jellyfish(`assets/img/2.Enemy/2 Jelly fish/Súper dangerous/Pink 1.png`,this.randomJellyType, this.randomXPosition))
      }
    }
     ...
     */
     generateCoins(){
       this.levelFactor = (this.levelLength*this.enemyMultiplicator)
        for (let index = 0; index < this.levelFactor; index++) {
        this.setRandomPosition();
        this.coins.push(new COINS(`assets/img/4. Marcadores/1. Coins/1.png`,this.randomXPosition))
      }
     }
     ...
     */
     generatePoison(){
       this.levelFactor = (this.levelLength*this.enemyMultiplicator)
        for (let index = 0; index < this.levelFactor; index++) {
        this.setRandomPosition();
        this.poison.push(new POISONS(`assets/img/4. Marcadores/Posión/Animada/1.png`,this.randomXPosition))
     }
    }
